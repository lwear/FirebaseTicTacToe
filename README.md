...
```
  ...
  Note: You need Java 11 for this to work. The school computers currently have Java 8. Here is the work around:
   - Extract the Java 11 zip file onto your H drive in an easy to find location: [jdk-11.0.17_windows-x64_bin.zip]("http://mdinfotech.net/downloads/jdk-11.0.17_windows-x64_bin.zip)
